...
Use this URL as the API Endpoint:

https://dashboard.heroku.com/apps/casting-agency-udacity-app

#### Login to the API

This API does not have a frontend, so it requires manual authentication. It requires an JSON token that can be generated by logging in in the following URL:

https://dev-on139kbu.auth0.com/authorize?audience=casting&response_type=token&client_id=MOidZ5GjJOCgRaroVg308GxpIxlUkxWw&redirect_uri=https://casting-agency-udacity-app.herokuapp.com/login_results

The HTTP requests need the `Authorization` header as follows:
...
- Sample: `curl https://casting-agency-udacity-app.herokuapp.com/movies`
...
- Sample: `curl https://casting-agency-udacity-app.herokuapp.com/movies/1`
...
- Sample: `curl https://casting-agency-udacity-app.herokuapp.com/movies -X POST -H "Content-Type: application/json" -d '{"title": "The Matrix Reloaded", "release_date": "16/05/2003" }'`
...
- Sample: `curl https://casting-agency-udacity-app.herokuapp.com/actors -X POST -H "Content-Type: application/json" -d '{"name": "Russell Crowe", "age": 60, "gender": "M" }'`
...
- Sample: `curl https://casting-agency-udacity-app.herokuapp.com/movies/1 -X POST -H "Content-Type: application/json" -d '{"actor_id": 3 }'`
...
- General:
  ...
  - Returns: Whether or not the request was completed and the movie model.
- Sample: `curl https://casting-agency-udacity-app.herokuapp.com/movies/3 -X PATCH -H "Content-Type: application/json" -d '{ "release_date": "16/05/2020" }'`
...
- General:
  ...
  - Returns: Whether or not the request was completed and the actor model.
- Sample: `curl https://casting-agency-udacity-app.herokuapp.com/actors/3 -X PATCH -H "Content-Type: application/json" -d '{ "gender": "F" }'`
...
- Sample: `curl https://casting-agency-udacity-app.herokuapp.com/movies/1 -X DELETE`
...
- Sample: `curl https://casting-agency-udacity-app.herokuapp.com/actors/1 -X DELETE`
